...
-**[Navegadores](https://es.wikipedia.org/wiki/Navegador_web):un navegador es un programa(complejo) que entiende y transforma el codigoque recibe desde un servidor, en algo entendible para un humano (una pagina wed,imagenes,etc)
